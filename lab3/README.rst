Lab 3: Introduction to Observability
====================================
...
#. Click the "Select Service" drop down menu on the sidebar and select "Observability".  
   ...
   .. image:: /assets/menu_observability.png
      :width: 75%
     
#. Click the "Add HTTP Monitor" button.

   .. image:: /assets/add_http_monitor.png
      :width: 75%
...
Press the X to close the report and return to the synthetic monitor statistics.
   ...
   .. image:: /assets/tls_report-link.png
      :width: 75%
  
  

   .. image:: /assets/tls-report.png
      :width: 75%
